        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('user.profilePost') }}">
                            @csrf
                            ...
                            <div class="form-group row">
                                <label for="forename"
                                       class="col-md-4 col-form-label text-md-right">{{ __('Forename') }}</label>

                                <div class="col-md-6">
                                    <input id="forename" type="text"
                                           class="form-control{{ $errors->has('forename') ? ' is-invalid' : '' }}"
                                           name="forename" value="{{ $user->forename }}" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select id="address" class="form-control" name="address" id="address">
                                        @foreach($user->addresses as $address)
                                            <option value="{{$address->id}}">
                                                {{$address->street . " " . $address->number . (isset($address->flat) ? "/" . $address->flat : "") . ", " . $address->city}}
                                            </option>
                                        @endforeach
                                    </select>
                                    <script>
                                        $().ready(function () {
                                            $("#address").val({{$user->address_id}})
                                        });
                                    </script>
    ...
    <div class="modal fade" id="addressModal"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                {!! Form::open(['method' => 'POST', 'route' => 'user.addAddress', 'class' => 'form']) !!}
                <div class="modal-body">
                    @include('partial.addressForm')
                </div>
